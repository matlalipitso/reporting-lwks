  ...
  const handleSubmitLectureReport = async (e) => {
    ...
    try {
      const reportData = {
        ...
        actual_students_present: parseInt(newLectureReport.actual_students_present),
        total_registered_students: parseInt(newLectureReport.total_registered_students)
      };

      // Validate that actual students present doesn't exceed total registered
      if (reportData.actual_students_present > reportData.total_registered_students) {
